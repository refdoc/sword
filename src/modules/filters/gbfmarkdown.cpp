/******************************************************************************
 *
 *  gbfmarkdown.cpp -	GBF to MarkDown
 *
 * $Id: gbfmarkdown.cpp 3328 2015-03-09 18:17:58Z refdoc $
 *
...
const char *GBFMarkDown::getHeader() const {
	return "MarkDown 2.1\n";
}

GBFMarkDown::MyUserData::MyUserData(const SWModule *module, const SWKey *key) : BasicFilterUserData(module, key) {
	if (module) {
		version = module->getName(); 
	}	
}

GBFMarkDown::GBFMarkDown() {
	setTokenStart("<");
	setTokenEnd(">");
...
bool GBFMarkDown::handleToken(SWBuf &buf, const char *token, BasicFilterUserData *userData) {
	const char *tok;
