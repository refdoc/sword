/******************************************************************************
 *
 *  thmlmarkdown.cpp -	ThML to classed MarkDown
 *
 * $Id: thmlmarkdown.cpp 3358 2015-03-22 18:09:07Z refdoc $
 *
...
const char *ThMLMarkDown::getHeader() const {
	return "\
	";
}


ThMLMarkDown::MyUserData::MyUserData(const SWModule *module, const SWKey *key) : BasicFilterUserData(module, key) {
	if (module) {
...
bool ThMLMarkDown::handleToken(SWBuf &buf, const char *token, BasicFilterUserData *userData) {
