/***************************************************************************
 *
 *  teimarkdown.cpp -	TEI to MARKDOWN filter
 *
 * $Id: teimarkdown.cpp 3393 2015-12-19 21:01:48Z refdoc $
 *
...
TEIMarkDown::MyUserData::MyUserData(const SWModule *module, const SWKey *key) : BasicFilterUserData(module, key) {
	BiblicalText = false;
	if (module) {
...
bool TEIMarkDown::handleToken(SWBuf &buf, const char *token, BasicFilterUserData *userData) {
